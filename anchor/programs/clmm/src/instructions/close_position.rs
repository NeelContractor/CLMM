...
use crate::utils::{ErrorCode, get_amounts_for_liquidity, get_sqrt_price_from_tick};
...
pub fn close_position(ctx: Context<ClosePosition>, lower_tick: i32, upper_tick: i32, _tick_array_lower_start_index: i32, _tick_array_upper_start_index: i32) -> Result<(u64, u64)> {
